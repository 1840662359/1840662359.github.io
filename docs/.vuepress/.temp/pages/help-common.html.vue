...
<p>解答：请确保您在软件里保存时，游戏已经关闭，且点击保存后软件提示了保存成功。如果仍然没有效果，请使用一键修复功能修复后再修改，可参考<RouteLink to="/help-modify.html">修改教程</RouteLink>里的视频步骤。</p>
